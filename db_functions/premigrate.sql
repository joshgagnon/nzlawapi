DROP VIEW IF EXISTS latest_instruments CASCADE;
DROP MATERIALIZED VIEW IF EXISTS newest CASCADE;
DROP MATERIALIZED VIEW IF EXISTS reference_counts CASCADE;
DROP MATERIALIZED VIEW IF EXISTS scores CASCADE;
